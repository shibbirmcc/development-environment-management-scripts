...
# Function to install Node.js plugin via asdf
...
# Function to list all remote versions
list_node_versions() {
    asdf list-all nodejs
}

# Function to set global default Node.js version
set_default_node() {
    local version=$1
...
# Function to use a version for current shell
use_node_version() {
    local version=$1
...
# Menu for managing Node.js versions
